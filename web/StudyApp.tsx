...
const StudyApp: React.FC = () => {
    ...
    const handleReaderSurfaceClick = (event: React.MouseEvent<HTMLDivElement>) => {
        ...
        // 单击 = 翻页；双击 = 恢复原来的阅读控制栏。
        // 这里故意延迟约一个双击间隔，避免第一下已经翻页后第二下又把书翻走。
        ...
        if (readerTapTimerRef.current !== null && pending && Date.now() - pending.time <= 360) {
        ...
        <div className={`xiaowo-study ${readerTheme === 'eink' ? 'eink-theme' : `reader-theme-${readerTheme}`}`} style={{
            ...
            <div ref={contentRef} style={{
                ...
                onPointerDown={mode === 'reading' ? (e) => {
                    ...
                    const bodyEl = pageEl?.querySelector('[data-page-main-content]') as HTMLElement | null;
                                ...
                                >
                                    ...
                                    <div
                                        ...
                                        style={{
                                            ...
                                            inset: 0,
                                            pointerEvents: 'none',
                                            background: 'linear-gradient(90deg, rgba(255,255,255,.22), transparent 22%, rgba(0,0,0,.10) 72%, rgba(0,0,0,.16))',
                                            mixBlendMode: 'normal',
                                            opacity: 0.18,
                                        }}
                                    />
