...
const StudyApp: React.FC = () => {
    ...
    }), [buildPageFragmentsForLayer, page]);
        ...
        <div className={`xiaowo-study ${readerTheme === 'eink' ? 'eink-theme' : `reader-theme-${readerTheme}`}`} style={{
            ...
            <div ref={contentRef} style={{
                ...
                onPointerDown={mode === 'reading' ? (e) => {
                    ...
                    const pageEl = document.querySelector('[data-page-content]') as HTMLElement | null;
                    if (!pageEl) return;
                ...
                onPointerMove={mode === 'reading' ? (e) => {
                    ...
                    if (pagePointerRafRef.current === null) {
                        pagePointerRafRef.current = window.requestAnimationFrame(() => {
                            ...
                            current.pageEl.style.transform = `translate3d(${dxNow}px, 0, 0)`;
                        });
                    }
                ...
                onPointerUp={mode === 'reading' ? (e) => {
                    ...
                    if (shouldCommit) {
                        ...
                        pageEl.style.transition =
                            `transform ${settleMs}ms cubic-bezier(0.2, 0.8, 0.2, 1)`;
                        pageEl.style.transform = `translate3d(${targetX}px, 0, 0)`;
